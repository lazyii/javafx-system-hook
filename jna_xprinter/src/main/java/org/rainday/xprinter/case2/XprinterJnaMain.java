...
public class XprinterJnaMain {
    ...
    public static void main(String[] args) throws WriterException {
        ...
        System.out.println(xprinter.unireturnState(fs, 1));
        System.out.println(xprinter.unireturnState(fs, 49));
        System.out.println(xprinter.unireturnState(fs, 2));
        System.out.println(xprinter.unireturnState(fs, 50));
        System.out.println("-----------------------------------");
        ...
        System.out.println(xprinter.uniWrite(fs, DataForSendToPrinterPos58.queryPrinterState()));
        byte[] rr = new byte[49];
        System.out.println(xprinter.uniRead(fs, rr));
